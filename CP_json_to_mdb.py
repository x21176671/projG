...
for i in range(len(recs)): # fill each year with appropriate dicts 
    ...
    if recs[i]["crop_year"] == 2006:
        crops2007.append(recs[i])
    if recs[i]["crop_year"] == 2005:
        crops2007.append(recs[i])
    if recs[i]["crop_year"] == 2004:
        crops2007.append(recs[i])
    if recs[i]["crop_year"] == 2003:
        crops2007.append(recs[i])
    if recs[i]["crop_year"] == 2002:
        crops2007.append(recs[i])
    if recs[i]["crop_year"] == 2000:
        crops2007.append(recs[i])
    if recs[i]["crop_year"] == 1999:
        crops2007.append(recs[i])
    if recs[i]["crop_year"] == 1998:
        crops2007.append(recs[i])
    if recs[i]["crop_year"] == 1997:
        crops2007.append(recs[i])
